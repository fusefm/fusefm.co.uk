...
<head>
  ...
  <meta name="keywords" content="fuse, fm, manchester, student, radio, university, webcast, uk, england, streaming, union, media, music, chat" />
  <meta name="description" content="Broadcasting from Manchester University Students' Union, Fuse FM is Manchester's awarding student radio station." />
  <link rel="apple-touch-icon" href="/sites/default/files/images/apple-touch-icon.png"/>
  <?php print $head; ?>
  <?php print $styles; ?>
  <?php print $scripts; ?>
</head>
        ...
        <div id="logo-title">
          ...
          <?php endif; ?>
              ...
              <div id="site-name"><strong>
                ...
                FUSEFM.CO.UK - MANCHESTER STUDENT RADIO
		</a></strong></div>
        </div> <!-- /#logo-title -->
      <?php endif; ?>
